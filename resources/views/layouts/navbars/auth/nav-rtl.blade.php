        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 px-0" id="navbar">
          ...
          <ul class="navbar-nav me-auto ms-0 justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <form id="logout-form-rtl" action="{{ route('logout') }}" method="POST" style="display: none;">
                @csrf
              </form>
              <a href="#" class="nav-link text-body font-weight-bold px-0" id="logoutButtonRtl">
              ...
              <script>
                document.addEventListener('DOMContentLoaded', function () {
                  var btn = document.getElementById('logoutButtonRtl');
                  if (btn) {
                    btn.addEventListener('click', function (e) {
                      ...
                      Swal.fire({
                        ...
                        if (result.isConfirmed) {
                          document.getElementById('logout-form-rtl').submit();
                        }
                      });
                    });
                  }
